...
public class Ternary {
	...
	/*
	    ...
	    System.out.println(Finals);
	      ...
	      int scoreMy = 80 ;
	      char FinalsMy = ' ' ;
	      FinalsMy = (scoreMy >= 90 && scoreMy <= 100) ? 'A' 
	    		  		: (scoreMy >=80 && scoreMy <90) ? 'B'
	    				      : (scoreMy >= 70 && scoreMy <80) ? 'C'
	    				    		  : (scoreMy >=60 && scoreMy < 70) ? 'D'
	    				    				  : (scoreMy >=0 && scoreMy <60) ? 'F'
	    				    						  :' ';
	       System.out.println(FinalsMy);
